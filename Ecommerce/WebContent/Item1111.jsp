...
<div class="container">
	<div class="row">
			<div class="col-md-4">
				<img src="pictures/Image 1.JPG" class="img-responsive">
			</div>
			<div class="col-md-5">
				<h1>Item 1</h1>
				<h4>Price: <span style="font-size:130%; color:red;"> 10.00 Units</span></h4>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin dignissim,
				 orci non sodales vulputate, elit ligula finibus urna, eget consequat arcu
				  neque sit amet elit. Nulla ullamcorper ex sed urna euismod gravida.
				   Maecenas egestas mauris.</p>
			</div>
			<div class="col-md-3">
				<s:form action="addCart">
					<s:textfield label="Item" key="itemName" value="Item 1"/>
					<s:textfield label="Price" key="price" value="10.00" readonly="true"/>
					<br><br>
					<s:submit/>
				</s:form>
			</div>
