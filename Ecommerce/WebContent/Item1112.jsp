...
<div class="container">
	<div class="row">
			<div class="col-md-4">
				<img src="pictures/Image 2.JPG" class="img-responsive">
			</div>
			<div class="col-md-5">
				<h1>Item 2</h1>
				<h4>Price: <span style="font-size:130%; color:red;"> 19.99</span></h4>
				<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ullamcorper
				 semper odio non lacinia. Donec nunc magna, ullamcorper sed massa ac, imperdiet
				  scelerisque tellus. Duis a sagittis nunc. Pellentesque euismod.</p>
			</div>
			<div class="col-md-3">
				<s:form action="addCart">
					<s:textfield label="Item" key="itemName" value="Item 2"/>
					<s:textfield label="Price" key="price" value="19.99" readonly="true"/>
					<br><br>
					<s:submit/>
				</s:form>
			</div>
